...
contract DAOTest is Test {
    ...
    function setUp() public {
        ...
        dao = new DAOGovernor(
            address(governanceToken), address(treasury), PROPOSAL_THRESHOLD, VOTING_PERIOD, QUORUM_VOTES
        );
    ...
    function testFundSpending() public {
        ...
        // Spend funds
        treasury.spendFundsForProposal(1, user2, spendingAmount, address(0));
        vm.stopPrank();
    ...
    function test_RevertWhen_FundSpendingWithoutApproval() public {
        ...
        treasury.spendFundsForProposal(1, user2, 1 ether, address(0));
        vm.stopPrank();
    }
